...
vector<NutritionalFacts> Burritos() {
  ...
  NutritionalFacts beanBurrito = {370, 10, 20, 1040, 58, 12,"Bean Burrito" , 1.69};
  NutritionalFacts beefBurrito = {430, 16, 40, 1330, 51, 20, "Beef Burrito" ,1.00};
  NutritionalFacts burritoSupreme = {400, 14, 25, 1170, 52, 16, "Burrito Supreme" ,4.39};
  NutritionalFacts quesarito = {450, 33, 50, 1420, 67, 21, "Quesarito" ,4.49};
  NutritionalFacts beefy5Layer = {490, 18, 25, 1260, 65, 18, "Beefy 5 Layer" ,3.39};
  NutritionalFacts chipRanchBurr = {510, 29, 45, 950, 47, 17, "Chipotle Ranch Grilled Chicken" ,2.00};
  NutritionalFacts chiliCheese = {380, 17, 35, 980, 41, 16, "Chilli Cheese Burrito" ,2.79};
  NutritionalFacts fiestaVeggie = {570, 28, 25, 1030, 65, 14, "Fiesta Veggie Burrito" ,2.00};
  NutritionalFacts cheesyBeanRice = {420, 16, 5, 920, 55, 9, "Cheesy Bean & Rice" ,1.00};
