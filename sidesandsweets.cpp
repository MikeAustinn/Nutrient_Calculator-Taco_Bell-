...
void displaysidesandsweetsFacts(NutritionalFacts2 sidesandsweetsFacts) {
  ...
  cout << "Total Carbohydrates: " << sidesandsweetsFacts.totalCarbohydrates << "g"
       << endl;
  cout << "Protein: " << sidesandsweetsFacts.protein << "g" << endl;
  cout << "Price: $" << fixed << setprecision(2) << sidesandsweetsFacts.price << endl;
}
...
vector<NutritionalFacts2> Sidessweets() {
  ...
  // Define the nutritional facts of sides & sweets
    NutritionalFacts2 cinnamonTwists = {170, 7, 2, 26, 0, 170, "Cinnamon Twists" ,1.29};
    NutritionalFacts2 chipsandGuac = {530, 29, 6, 64, 5, 510, "Chips and Guac" ,2.49};
    NutritionalFacts2 chipsandQueso = {620, 39, 13, 49, 15, 950, "Chips and Queso" ,2.69};
    NutritionalFacts2 caramelappleEmpanada = {310, 16, 3, 40, 5, 180, "Caramel Apple Empanada" ,1.19};
  ...
  while (continueOrdering) {
   ...
   do {
    ...
    case 4:
      ...
      break;
      default:
      cout << "Invalid choice. Please choose a sides & sweets from the menu." << endl;
    }
    // Ask if the user wants to continue ordering
    char answer;
    cout << "Do you want to add another sides & sweets? (Y/N): ";
    cin >> answer;
    if (toupper(answer) == 'N') {
        break;
